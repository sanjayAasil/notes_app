...
class Note {
  ...
  factory Note.create({required String title, required String note}) =>
      Note._(uid: DataManager().user?.uid, id: const Uuid().v4(), title: title, note: note, createdAt: DateTime.now());
