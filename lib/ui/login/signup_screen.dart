        ...
        children: [
          Container(
            ...
            child: Padding(
              ...
              child: const Text('Create Your\nAccount', style: TextStyle(fontSize: 30, color: Colors.white)),
            ),
          ),
          Padding(
                    ...
                    InkWell(
                      onTap: () async {
                        if (emailController.text.trim().isEmpty ||
                            ...
                            conformPasswordController.text.trim().isEmpty) {
                          return;
                        }
                        if (passwordController.text.trim() != conformPasswordController.text.trim()) {
                          ScaffoldMessenger.of(
                            context,
                          ).showSnackBar(const SnackBar(content: Text('Password should be same')));
                          return;
                        }
...
signUp(BuildContext context, String email, String password) async {
  LoadingDialog loadingDialog = LoadingDialog(progressbarColor: Colors.yellow.shade700, message: 'Verifying')
    ..show(context);
