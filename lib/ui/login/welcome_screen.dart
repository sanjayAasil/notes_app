      ...
      body: Container(
        ...
        child: Column(
          children: [
            ...
            const Icon(Icons.lightbulb_outline_rounded, size: 150, color: Colors.white),
            const SizedBox(height: 10),
            const Text('Welcome Back !', style: TextStyle(color: Colors.white, fontSize: 35)),
            ...
            Row(
              ...
              children: [
                InkWell(
                  ...
                  child: const Icon(Icons.g_mobiledata_rounded, color: Colors.white, size: 90),
                ),
                ...
                InkWell(
                  ...
                  child: const Padding(
                    ...
                    child: Icon(Icons.phone_outlined, color: Colors.white, size: 50),
                  ),
                ),
              ],
            ),
            TextButton(
              onPressed: () async {
                  try {
                    ...
                    LoadingDialog loadingDialog = LoadingDialog(progressbarColor: Colors.yellow)..show(context);
                    ...
                    DataManager().notify();
                    debugPrint("_WelcomeScreenState signIn Anon: ${user.uid}");
              ...
              child: Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Text("       Skip", style: TextStyle(color: Colors.white, fontWeight: FontWeight.w500, fontSize: 17)),
