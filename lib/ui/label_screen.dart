    ...
    return InkWell(
      ...
      child: Row(
        children: [
          ...
          Expanded(child: Padding(padding: const EdgeInsets.all(10.0), child: Text(widget.label))),
          InkWell(
            ...
            child: Padding(
              padding: const EdgeInsets.all(10.0),
              child:
                  widget.selectedLabels.contains(widget.label)
                      ? Icon(Icons.check_box, color: Colors.yellow.shade700)
